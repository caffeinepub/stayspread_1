...
import { Copy, Check, Megaphone, DollarSign } from 'lucide-react';
...
export default function PromoterDashboard() {
  ...
  const referralUrl = referralCode ? `${baseUrl}/listings?ref=${referralCode}` : '';
  ...
  if (!isAuthenticated) {
    return (
      <div className="container py-12 text-center">
        <h1 className="text-2xl font-bold mb-4">Please login to access the promoter dashboard</h1>
      </div>
    );
  }
  ...
  if (!isPromoter) {
    return (
      <div className="container py-12 text-center">
        ...
        <p className="text-muted-foreground">Only promoters can access this dashboard</p>
      </div>
    );
  }
  ...
  return (
    <div className="container py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Share properties and earn commissions</p>
      </div>
          ...
          <CardContent className="space-y-4">
            {isLoading ? (
              ...
              <>
                ...
                <Button onClick={handleCopy} className="w-full" disabled={!referralUrl}>
                  {copied ? (
                    <>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Use your unique referral link when sharing properties on social media, blogs, or with friends
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Earn 8% commission on every booking made through your referral link
                </p>
              </div>
            </div>
          </div>
